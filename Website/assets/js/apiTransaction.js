const MOVIE_DB_API = /* Enter the api here */ ;
...
function search(id) {
    const url2 = `/movie/${id}/similar`;
    const url = generateMovieDBUrl(url2);
    const render = renderMovies.bind({ title: 'Recomended Movie' });
